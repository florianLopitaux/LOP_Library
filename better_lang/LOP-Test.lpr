;; -*- lisp-version: "10.1 [32-bit Windows] (Jul 16, 2018 21:53)"; -*-

(in-package :cg-user)

(define-project :name :lop-test
  :modules (list (make-instance 'module :name "lop-test.package.lisp")
                 (make-instance 'module :name "functional/functional.lang.test.lisp")
                 (make-instance 'module :name "oo/oo.lang.test.lisp")
                 (make-instance 'module :name "bis/bis.lang.test.lisp")
                 (make-instance 'module :name "rule/rule.lang.test.lisp")
                 (make-instance 'module :name "workflow/workflow.test.lisp"))
  :projects (list (make-instance 'project-module :name "LOP" :show-modules t))
  :libraries nil
  :editable-files nil
