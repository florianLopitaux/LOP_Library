...
(defun customer-details-on-change (widget new-value old-value)
  ...
  (cond
    ...
    (functional:else
      ...
      (setf (value history-field) (oo:to-list-string-details (borrowing-system:findAllRecordsFromCustomer customer)))
      )
    )
  ))
t) ;; end function
...
(defun customer-role-on-change (widget new-value old-value)
  ...
  (setf (value price-field) (payment-system:computeSubscriptionPrice new-value))
  )
